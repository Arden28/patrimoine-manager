...
const NotificationsPage = ({ user, notifications, onLogout }) => {
  return (
      ...
      <div className="flex-1 md:ml-64 p-6 lg:p-8">
        ...
        <div className="animate-fade-in">
          <div className="bg-white p-6 rounded-xl shadow-sm">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">Your Notifications</h2>
            <div className="space-y-4">
              {notifications.map(notification => (
                ...
                >
                  ...
                  <div className="flex-1 text-right">
                    <button className="text-teal-500 hover:text-teal-600 font-medium">Dismiss</button>
                  </div>
                </div>
              ))}
            </div>
